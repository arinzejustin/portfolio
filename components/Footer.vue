...
<template>
  ...
  >
    ...
    >
      ...
      >
        <h2
          class="font-funky text-3xl md:text-4xl font-bold mb-2 text-center md:text-left blur-text"
        >
          Contact Me Directly
        </h2>
      ...
      <div class="order-3 md:order-1 w-full md:w-1/2">
        <h2
          class="font-funky blur-text text-3xl md:text-4xl font-bold mb-6 text-center md:text-left"
        >
          Send me a message
        </h2>
    ...
    >
      ...
      <div class="flex flex-row justify-center space-x-6 items-center">
        <NuxtLink
          to="https://x.com/justin_axo" target="_blank"
          class="hover:text-teal-400"
        >
          <Icon icon="pajamas:twitter" width="28" height="28" />
        </NuxtLink>
        <NuxtLink
          to="https://github.com/arinzejustin" target="_blank"
          class="hover:text-teal-400"
        >
